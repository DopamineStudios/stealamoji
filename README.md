...
This project is open source under the **GNU Affero General Public License v3.0 (AGPL-3.0)**. If you modify Steal-a-moji and run it as a network service, you must share your modified source under the same license.
