...
bot = BeaconAutoShardedBot(intents=discord.Intents.default(), minimal_caching=True, accent_colour=discord.Colour(0xf7c22b), bot_logger=logger, http_timeout=10.0)
